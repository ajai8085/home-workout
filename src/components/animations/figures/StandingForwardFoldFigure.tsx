/* Side-view: torso hinges forward from hips, arms hang */
interface Props {
  color: string
}

export function StandingForwardFoldFigure({ color }: Props) {
  const s = { stroke: color, strokeWidth: 3.5, strokeLinecap: 'round' as const }

  return (
    <svg viewBox="0 0 200 270" fill="none" {...s}>
      {/* Legs (static, soft bend at knee) */}
