/* Side-view deep lunge, one arm rotates from down to overhead */
interface Props {
  color: string
}

export function WorldsGreatestStretchFigure({ color }: Props) {
  ...
  return (
    <svg viewBox="0 0 220 270" fill="none" {...s}>
      ...
      {/* Torso (forward lean in lunge) */}
      <line x1="128" y1="65" x2="105" y2="130" />
      {/* Front arm (down to floor position) */}
      <line x1="118" y1="85" x2="88" y2="155" />
      {/* Animated rear arm (rotates from down to overhead) */}
      <line
        x1="118"
        y1="85"
        x2="145"
      ...
      />
      {/* Front leg (lunge, knee bent at ~90°) */}
