/* Side-view: body at diagonal to wall, translates toward and away */
interface Props {
  color: string
}

export function WallPushUpFigure({ color }: Props) {
